	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<form id="item" action="admin/account" method="post"
							...
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="form-group row">
										<label class="col-sm-2 col-form-label"> ID Tài Khoản </label>
										<div class="col-sm-10">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input id="username" name="username" class="form-control"
												placeholder="username2022" type="text" value="" /> <span>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input id="fullname" name="fullname" class="form-control"
												placeholder="Nguyễn Văn A" type="text" value="" /> <span>
								...
								<div class="col-xl-6">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input id="phone" name="phone" class="form-control"
												placeholder="0362833310" type="text" value="" /> <span>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input id="address" name="address" class="form-control"
												placeholder="Cần Thơ" type="text" value="" /> <span>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input id="email" name="email" class="form-control"
												placeholder="abc@example.com" type="email" value="" /> <span>
									...
									<div class="form-group row">
										...
										<div class="form-check-inline my-2">
											<span><input id="admin1" name="admin"
												class="form-check-input ml-3" type="radio" value="false"
												checked="checked" /><label for="admin1">User</label></span><span><input
												id="admin2" name="admin" class="form-check-input ml-3"
												type="radio" value="true" /><label for="admin2">Admin</label></span>
											<span> </span>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="file" name="img" class="custom-file-input" /> <label
												class="custom-file-label mx-3">Choose file</label>
						...
						<table id="datatable-buttons"
							...
							<tbody>
								...
								<tr>
									...
									<td>Admin</td>
									<td>Yes</td>
									<td class="text-center"><img class="w-50"
										src="img/accounts/cherry.png"></td>
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/admin"
								...
								<tr>
									...
									<td>Yes</td>
									<td class="text-center"><img class="w-50"
										src="img/accounts/noavt.png"></td>
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/bmaclee2"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/cbatille"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/crafeoa"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/dstewart"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/duyplus"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/gsipper9"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/hfoucar5"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/hgoomesh"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/hnorgan8"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/kpenritg"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/mlovejoy3"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/ngerdez4"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/pcaelnic"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/pcowell1"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/pdolane"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/rfealeyi"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/tantv"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/tgilletb"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/tjerach7"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
								...
								<tr>
									...
									<td>
										<div class="btn-group btn-group-sm">
											<a href="admin/account/edit/vyahin6"
												class="btn btn-sm btn-success text-white"> <span
												class="ti-pencil"></span>
											</a>
										</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a href="admin/account/delete/" class="btn btn-primary"> Có,
