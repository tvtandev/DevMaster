...
<title>QuickBuy - Quần Áo, Balo, Giày</title>
						...
						<div class="col-lg-5">
							...
							<div class="pd-breadcrumb u-s-m-b-30">
								<ul class="pd-breadcrumb__list">
									...
									<li class="is-marked"><a href="shop-side-version-2">Áo
											thun unisex nam nữ...</a></li>
								</ul>
							</div>
						...
						<div class="col-lg-7">
							...
							<div class="pd-detail">
								<div>
									...
									<span class="pd-detail__name">Áo thun unisex nam nữ form
										rộng tay lỡ phông teen cổ tròn oversize cotton giá rẻ basic
										đen trắng tee pull STANFORD</span>
								</div>
								<div>
									<div class="pd-detail__inline">

										<span class="pd-detail__price">231.000 VNĐ</span> <span
								...
								<div class="u-s-m-b-15">
									<div class="pd-detail__inline">
										...
										<span class="pd-detail__stock">200 trong kho</span> <span
											class="pd-detail__left">Chỉ còn 2</span>
									</div>
								</div>
								<div class="u-s-m-b-15">
									...
									<form class="pd-detail__form">
										<div class="u-s-m-b-15">
											...
											<div class="pd-detail__color">
												...
												<div class="color__radio">
													...
													<input type="radio" id="folly" name="color"> <label
														class="color__radio-label" for="folly"
														style="background-color: #FF0055"></label>
												</div>
												<div class="color__radio">

													<input type="radio" id="yellow" name="color"> <label
														class="color__radio-label" for="yellow"
										...
										<div class="u-s-m-b-15">
											...
											<div class="pd-detail__size">
												<div class="size__radio">
													...
													<input type="radio" id="xs" name="size" checked> <label
														class="size__radio-label" for="xs">XS</label>
												</div>
												<div class="size__radio">

													<input type="radio" id="small" name="size"> <label
														class="size__radio-label" for="xxl">Small</label>
												</div>
												<div class="size__radio">

													<input type="radio" id="medium" name="size"> <label
														class="size__radio-label" for="medium">Medium</label>
												</div>
												<div class="size__radio">

													<input type="radio" id="large" name="size"> <label
														class="size__radio-label" for="xxl">Large</label>
												</div>
												<div class="size__radio">

													<input type="radio" id="xl" name="size"> <label
														class="size__radio-label" for="xl">XL</label>
												</div>
												<div class="size__radio">

													<input type="radio" id="xxl" name="size"> <label
														class="size__radio-label" for="xxl">XXL</label>
												</div>
											</div>
										</div>
										<div class="pd-detail-inline-2">
											...
											<div class="u-s-m-b-15">
												...
												<button class="btn btn--e-brand-b-2" formaction="checkout">Mua ngay</button>
											</div>
										</div>
									</form>
								</div>
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="pd-desc">
										<div class="pd-tab__desc">
											<div class="u-s-m-b-15">
												<p>Áo thun unisex nam nữ form rộng tay lỡ phông teen cổ
													tròn oversize cotton giá rẻ basic đen trắng tee pull
													STANFORD là một chiếc áo thun có thiết kế dễ mặc, phù hợp
													với cả nam và nữ. Áo có form rộng tay lỡ phông phù hợp với
													thời trang teen, cổ tròn và oversize cho vẻ ngoài thật
													thoải mái và đáng yêu. Chất liệu cotton thoáng mát, mềm
													mại, dễ chịu khi mặc. Sản phẩm có giá cả hợp lý và phù hợp
													với các dịp thường ngày.</p>
											</div>
											<div class="u-s-m-b-30">
												...
												<div class="pd-table gl-scroll">
													<table>
														<tbody>
															...
															<tr>
																<td>Gửi từ</td>
																<td>Thành Phố Hồ Chí Minh</td>
															</tr>
														</tbody>
													</table>
												</div>
