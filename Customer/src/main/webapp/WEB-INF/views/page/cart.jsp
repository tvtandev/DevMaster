                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    <li class="has-separator">
                                        ...
                                        <a href="index">Trang chủ</a></li>
                                    <li class="is-marked">

                                        <a href="cart">Giỏ hàng</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="route-box">
                                    <div class="route-box__g1">
                                        ...
                                        <a class="route-box__link" href="shop-side-version-2"><i class="fas fa-long-arrow-alt-left"></i>

                                            <span>TIẾP TỤC MUA SẮM</span></a></div>
                                    <div class="route-box__g2">

                                        <a class="route-box__link" href="cart"><i class="fas fa-trash"></i>

                                            <span>XÓA GIỎ HÀNG</span></a>

                                        <a class="route-box__link" href="cart"><i class="fas fa-sync"></i>

                                            <span>CẬP NHẬT GIỎ HÀNG</span></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 u-s-m-b-30">
                                            <div class="f-cart__pad-box">
                                                ...
                                                <span class="gl-text u-s-m-b-30">Nhập điểm đến của bạn để có ước tính vận chuyển.</span>
                                                
                                                <div class="u-s-m-b-30">

                                                    <!--====== Select Box ======-->

                                                    <label class="gl-label" for="shipping-state">TỈNH/THÀNH PHỐ, QUẬN/HUYỆN, PHƯỜNG/XÃ</label><select class="select-box select-box--primary-style" id="shipping-state">
                                                ...
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <a class="f-cart__ship-link btn--e-transparent-brand-b-2" href="cart">TÍNH TOÁN PHÍ VẬN CHUYỂN</a></div>

                                                <span class="gl-text">Lưu ý: Có một số Tỉnh, Thành miễn phí vận chuyển, nếu không, phí cố định hoặc phí giao hàng Tỉnh, Thành Phố của chúng tôi sẽ được áp dụng.</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 u-s-m-b-30">
                                            <div class="f-cart__pad-box">
                                                ...
                                                <span class="gl-text u-s-m-b-30">Thêm ghi chú đặc biệt về sản phẩm của bạn</span>
                                                <div>
                                        ...
                                        <div class="col-lg-4 col-md-6 u-s-m-b-30">
                                            <div class="f-cart__pad-box">
                                                ...
                                                <div>
                                                    ...
                                                    <button class="btn btn--e-brand-b-2" formaction="checkout">THANH TOÁN NGAY</button></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
